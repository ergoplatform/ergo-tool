...
import org.ergoplatform.appkit.cli.{ConfigOption, ConsoleTesting, Console}

trait CommandsTesting extends ConsoleTesting
    with MockitoSugar
    with ArgumentMatchersSugar { self: Matchers =>
